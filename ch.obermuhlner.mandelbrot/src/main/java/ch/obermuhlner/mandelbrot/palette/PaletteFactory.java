...
public class PaletteFactory {
	...
	public Palette createPalette(PaletteType paletteType, int seed, int steps) {
		...
		case Fire:
			return new MaxValuePalette(new CachingPalette(new InterpolatingPalette(new FixPalette(new CyclingPalette(Color.RED, Color.YELLOW, Color.DARKRED, Color.ORANGE, Color.gray(0.1)), FIX_COLORS), steps)));
		case Water:
			return new MaxValuePalette(new CachingPalette(new InterpolatingPalette(new FixPalette(new CyclingPalette(Color.BLUE, Color.LIGHTBLUE, Color.DARKBLUE, Color.CYAN, Color.gray(0.1)), FIX_COLORS), steps)));
		case Air:
			return new MaxValuePalette(new CachingPalette(new InterpolatingPalette(new FixPalette(new CyclingPalette(Color.LIGHTBLUE, Color.WHITE, Color.BLUE, Color.WHITE, Color.CYAN), FIX_COLORS), steps)));
		case Earth:
			return new MaxValuePalette(new CachingPalette(new InterpolatingPalette(new FixPalette(new CyclingPalette(Color.SADDLEBROWN, Color.GREEN, Color.DARKGREEN, Color.BROWN, Color.SANDYBROWN), FIX_COLORS), steps)));
		case Forest:
			return new MaxValuePalette(new CachingPalette(new InterpolatingPalette(new FixPalette(new CyclingPalette(Color.GREENYELLOW, Color.GREEN, Color.DARKGREEN, Color.LIGHTGREEN, Color.gray(0.1)), FIX_COLORS), steps)));
		case StarryNight:
			return new MaxValuePalette(new CachingPalette(new InterpolatingPalette(new FixPalette(new CyclingPalette(Color.DARKBLUE, Color.WHITE, Color.gray(0.1), Color.MIDNIGHTBLUE, Color.gray(0.1)), FIX_COLORS), steps)));
		case Rainbow:
